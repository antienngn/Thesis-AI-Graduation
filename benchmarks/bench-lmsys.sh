#fcfs
# CUDA_VISIBLE_DEVICES=0 python -m vllm.entrypoints.openai.api_server --model meta-llama/Meta-Llama-3-8B-Instruct --swap-space 16 --disable-log-requests --schedule-type fcfs --enable-chunked-prefill --enforce-eager --dtype=half --port 3343 &
# sleep 60
...
#opt-ours
# CUDA_VISIBLE_DEVICES=1 python -m vllm.entrypoints.openai.api_server --model meta-llama/Meta-Llama-3-8B-Instruct --swap-space 16 --disable-log-requests --schedule-type opt-xxx --enable-chunked-prefill --enforce-eager --dtype=half --prefill-predictor-model-config MODEL/results/opt-125m-llama3-8b-lmsys-score-trainbucket10-b32/usage_config.json &
# sleep 60
...
# #mlfq
# CUDA_VISIBLE_DEVICES=2 python -m vllm.entrypoints.openai.api_server --model meta-llama/Meta-Llama-3-8B-Instruct --swap-space 50 --disable-log-requests --schedule-type mlfq-quant0.03-thres2 --enable-chunked-prefill --enforce-eager --dtype=half &
# sleep 200
...
# #opt-class10
# CUDA_VISIBLE_DEVICES=3 python -m vllm.entrypoints.openai.api_server --model meta-llama/Meta-Llama-3-8B-Instruct --swap-space 50 --disable-log-requests --schedule-type tpt-class10-xxx --enable-chunked-prefill --enforce-eager --dtype=half --prefill-predictor-model-config MODEL/results/opt-125m-llama3-8b-lmsys-class-trainbucket820-b32/usage_config.json &
# sleep 120
