...
CUDA_VISIBLE_DEVICES=2 python -m vllm.entrypoints.openai.api_server \
    ...
    --port 3303 \
    --prefill-predictor-model-config MODEL/results/pythia-14m-llama3-8b-sharegpt-score-trainbucket10-b32/usage_config_ov.json &
sleep 60
...
python benchmark_serving_real.py --backend vllm \
    ...
    --port 3303 --result-dir TEMP_RES_ASYNC_MERGE_PYTHIA_14M
