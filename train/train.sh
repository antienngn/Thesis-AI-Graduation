...
python trainer.py --config configs/config_prefill_opt.txt --file ../benchmarks/llama3-8b-sharegpt-train-t1-s0-8192.jsonl --job-dir MODEL --run-id opt-125m-llama3-8b-sharegpt-score-trainbucket10-b32 --batch-size 4 --label-group-size 10 --loss listMLE
